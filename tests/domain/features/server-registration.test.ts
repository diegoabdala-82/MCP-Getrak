...
import { registerFeatureTools } from "../../../src/domain/features/index.js";
...
describe("Epic 22 — registro das 3 tools de features no servidor MCP", () => {
  it("expõe as 3 tools na descoberta nativa", async () => {
    ...
    registerFeatureTools(registerDomainTool, {
    ...
    expect(names).toEqual(["get_all_available_features", "get_central_feature_flags", "get_central_features"]);
  });
});
