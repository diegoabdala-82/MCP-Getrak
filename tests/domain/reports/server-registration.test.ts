...
import { registerReportTools } from "../../../src/domain/reports/index.js";
...
describe("Epic 13 — registro das 2 tools de reports no servidor MCP", () => {
  it("expõe as 2 tools na descoberta nativa", async () => {
    ...
    registerReportTools(registerDomainTool, {
    ...
    expect(names).toEqual(["get_reports_summary", "search_reports"]);
  });
});
