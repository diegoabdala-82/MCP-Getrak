...
import { registerPerimeterTools } from "../../../src/domain/perimeters/index.js";
...
describe("Epic 10 — registro das 3 tools de perimeters no servidor MCP", () => {
  it("expõe as 3 tools na descoberta nativa", async () => {
    ...
    registerPerimeterTools(registerDomainTool, {
    ...
    expect(names).toEqual(["search_geofences", "search_perimeter_categories", "search_reference_points"]);
  });
});
