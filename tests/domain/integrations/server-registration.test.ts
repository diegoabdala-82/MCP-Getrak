...
import { registerIntegrationTools } from "../../../src/domain/integrations/index.js";
...
describe("Epic 10 — registro da tool de integrations no servidor MCP", () => {
  it("expõe a tool na descoberta nativa", async () => {
    ...
    registerIntegrationTools(registerDomainTool, {
    ...
    expect(names).toEqual(["search_central_integrations"]);
  });
});
