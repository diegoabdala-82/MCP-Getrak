...
import { registerJourneyTools } from "../../../src/domain/journeys/index.js";
...
describe("Epic 20 — registro das 10 tools de journeys no servidor MCP", () => {
  it("expõe as 10 tools na descoberta nativa", async () => {
    ...
    registerJourneyTools(registerDomainTool, {
    ...
    expect(names).toEqual([
      "get_available_vehicles_for_journey",
      "get_driver_details",
      "get_drivers_summary",
      "get_identifier_history",
      "get_identifiers_summary",
      "get_journey_details",
      "get_journeys_summary",
      "search_drivers",
      "search_identifiers",
      "search_journeys",
    ]);
