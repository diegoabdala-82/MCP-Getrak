...
describe("get_identifier_history — integração via ToolRuntime", () => {
  it("bloqueia cross-central antes de chamar a API Core", async () => {
    ...
    const envelope = await runtime.execute(
      definition,
      { central: "central-99", driver_id: 1 },
  ...
  it("bloqueia com VALIDATION_ERROR quando driver_id está ausente, antes de chamar a API Core", async () => {
