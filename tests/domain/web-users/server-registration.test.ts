...
import { registerWebUserTools } from "../../../src/domain/web-users/index.js";
...
describe("Epic 16 — registro das 3 tools de web_users no servidor MCP", () => {
  it("expõe as 3 tools na descoberta nativa", async () => {
    ...
    registerWebUserTools(registerDomainTool, {
    ...
    expect(names).toEqual(["get_current_user", "get_user_details", "search_web_users"]);
  });
});
