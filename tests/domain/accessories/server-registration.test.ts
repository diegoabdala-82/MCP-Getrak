...
import { registerAccessoryTools } from "../../../src/domain/accessories/index.js";
...
describe("Epic 10 — registro das 3 tools de accessories no servidor MCP", () => {
  it("expõe as 3 tools na descoberta nativa", async () => {
    ...
    registerAccessoryTools(registerDomainTool, {
    ...
    expect(names).toEqual(["get_accessories_summary", "search_accessories", "search_accessory_categories"]);
  });
});
