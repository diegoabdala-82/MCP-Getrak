...
import { registerNotificationTools } from "../../../src/domain/notifications/index.js";
...
describe("Epic 18 — registro das 2 tools de notifications no servidor MCP", () => {
  it("expõe as 2 tools na descoberta nativa", async () => {
    ...
    registerNotificationTools(registerDomainTool, {
    ...
    expect(names).toEqual(["get_messages_analytics", "search_messages"]);
  });
});
