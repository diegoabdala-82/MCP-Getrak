...
import { registerOperationTools } from "../../../src/domain/operations/index.js";
...
describe("Epic 19 — registro da tool de operations no servidor MCP", () => {
  it("expõe a tool na descoberta nativa", async () => {
    ...
    registerOperationTools(registerDomainTool, {
    ...
    expect(names).toEqual(["search_operations"]);
  });
});
