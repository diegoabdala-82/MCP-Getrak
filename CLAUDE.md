...
4. Specs individuais por User Story (pasta `Claude Code / Specs` no Notion — 61 documentos: US-001 a US-048, US-067 a US-069 (Epic 16), US-070 a US-076 (Epic 17), US-077 a US-078 (Epic 18) e US-079 (Epic 19), exceto lacunas registradas na Seção 9)
...
Total: 41 tools MCP registradas, 311 testes automatizados.
