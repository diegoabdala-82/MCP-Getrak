...
4. Specs individuais por User Story (pasta `Claude Code / Specs` no Notion — 60 documentos: US-001 a US-048, US-067 a US-069 (Epic 16), US-070 a US-076 (Epic 17) e US-077 a US-078 (Epic 18), exceto lacunas registradas na Seção 9)
...
Total: 40 tools MCP registradas, 301 testes automatizados.
